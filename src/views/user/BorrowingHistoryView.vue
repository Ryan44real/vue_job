...
defineOptions({ name: 'BorrowingHistoryView' })
  ...
  <div>
    <el-table v-if="books.length" :data="books" stripe>
      ...
      <el-table-column label="状态" width="90">
        <template #default><el-tag type="success" size="small">已归还</el-tag></template>
      </el-table-column>
      <el-table-column label="借书日期" prop="borrowDate" width="110" />
      <el-table-column label="还书日期" prop="deadline" width="110" />
    </el-table>
    <AppEmptyState v-else description="暂无借阅历史" />
