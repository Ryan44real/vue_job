...
<template>
    ...
    <el-row>
        <el-col :span="7">
            <img
        style="width: 90px"
        src="C:\Users\Rain\Desktop\BYSJ\BookSys\BookSys-vue\vue_job\src\assets\logo.png"
        alt="Element logo"
      />
        </el-col>

        <el-col :span="12">
            <h1>欢迎来到图书数字化管理系统的图书查询</h1>
        </el-col>

        <el-col :span="5">
            <button style="font-size: 20px; color: #5589ff;" @click="checkLogin()">去登录</button>
        </el-col>
    </el-row>
